...
<body style="background-color: #004528;">
	...
	<div class="form1">
		...
		<input class="form-control" type="text" name="userType" value="<?php echo $userType; ?>">
	...
	<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1= "UPDATE users SET pic='$pic', first='$first', last='$last', username='$username', password='$password', email='$email', contact='$contact' WHERE username='".$_SESSION['login_user']."';";
